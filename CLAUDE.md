...
OMP is a TypeScript plugin for GitHub Copilot CLI that brings 18 specialized agents, 30+ skills, a HUD display, a Plugin State Manager (PSM), and MCP server integration to every session.
...
spec/AGENTS_SPEC.md   → 18-agent table & model tiers
spec/SKILLS.md        → 30+ skills & lazy loading
